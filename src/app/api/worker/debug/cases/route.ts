...
export async function GET(request: Request) {
  ...
  const SELECT =
    "id, patient_name, patient_email, patient_dob, lab_name, zenoti_service_name, collection_date, lab_external_ref, tracking_number, zenoti_appointment_id, zenoti_guest_id, dismissed_refs, step1_sample_sent, step2_partial_received, step3_partial_uploaded, step4_complete_received, step5_complete_uploaded, step6_rof_scheduled, step7_rof_completed, archived_at, deleted_at, created_at, updated_at, notes";
