// Reports sub-tab — the original /labs/reports content, unchanged, lifted into
// a sub-view of the Analytics page. Server component: fetches its own data.

import { getReportData } from "../actions";
import { COLUMN_LABEL, COLUMN_ORDER } from "@/lib/columns";
import { LearnTurnaroundsPanel } from "../reports/LearnTurnaroundsPanel";
