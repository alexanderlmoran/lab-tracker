...
const RAW: IvComponent[] = [
  ...
  { label: "Arginine" },
  { label: "Ascorbic Acid (Vitamin C) 500mg/ml", standardDose: "10mL" },
  { label: "B-Complex", standardDose: "2mL" },
  { label: "Biotin" },
  { label: "Calcium Gluconate" },
  { label: "Carnitine 500mg/ml", standardDose: "10mL" },
  ...
  { label: "Lysine" },
  { label: "Magnesium 200mg/ml", standardDose: "4mL" },
